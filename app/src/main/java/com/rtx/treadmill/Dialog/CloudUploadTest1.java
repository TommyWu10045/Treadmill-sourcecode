...
public class CloudUploadTest1 extends Rtx_BaseLayout {
    ...
    public CloudUploadTest1(Context context, MainActivity mMainActivity) {
        super(context);
    ...
    private void add_View()
    {
        ...
        fsize = 29.68f;
        sdata = "Close";
        addRtxTextView(f_back, f_close, sdata, fsize, Common.Color.background_dialog, Common.Font.KatahdinRound, Typeface.NORMAL, Gravity.CENTER, ix, iy, iw, ih);
