...
public class TitleImageInfoLayout extends Rtx_BaseLayout {
    ...
    public TitleImageInfoLayout(Context context, MainActivity mMainActivity) {
        super(context);
    ...
    private void add_View()
    {
        ...
        iw = 70 ;
        ih = 70;
        addRtxImage(f_back, imageView_Title, -1, ix, iy, iw, ih, ipadding, null);
