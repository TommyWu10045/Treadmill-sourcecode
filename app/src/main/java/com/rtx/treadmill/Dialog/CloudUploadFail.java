...
public class CloudUploadFail extends Rtx_BaseLayout {
    ...
    private RtxFillerTextView   f_ok;

    public CloudUploadFail(Context context, MainActivity mMainActivity) {
        super(context);
    ...
    private void init_View()
    {
        ...
        if(f_ok == null)     { f_ok = new RtxFillerTextView(mContext);     }

    }

    private void init_event()
    {
        f_ok.setOnClickListener(mButtonListener);
    }
    ...
    private void add_View()
    {
        ...
        ih = 60;
        fsize = 29.68f;
        sdata = LanguageData.s_get_string(mContext, R.string.ok);
        addRtxTextView(f_back, f_ok, sdata, fsize, Common.Color.background_dialog, Common.Font.KatahdinRound, Typeface.NORMAL, Gravity.CENTER, ix, iy, iw, ih);
        f_ok.setBackgroundColor(Common.Color.info_word_pink);
