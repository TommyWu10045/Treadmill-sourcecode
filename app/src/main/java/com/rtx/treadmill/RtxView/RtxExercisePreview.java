 ...
 */
public class RtxExercisePreview extends Rtx_BaseLayout {
    ...
    private boolean bSpeedLable = true;
    private boolean bInclineLable = true;
    ...
    public RtxExercisePreview(Context context, int iMode){
        super(context);
    ...
    public void init(float fscale , int iDataCount)
    {
        ...
        iw = iGet_Scale(80);
        ih = iGet_Scale(40);
        fsize = fGet_Scale(15.96f);
        sdata = LanguageData.s_get_string(mContext, R.string.incline);
        ...
        if(bXScale) {
            ...
            i_xprofile.init(iDataCount, fscale, ix, iy, iw, ih);
        }
        ...
        i_profile.init(iDataCount, iGet_YMin(), iGet_YMax(), fscale, ix, iy, iw, ih);
    }
