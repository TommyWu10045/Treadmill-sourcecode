...
public class RtxDialog_TargetClose_Layout extends Rtx_BaseLayout {
    ...
    public RtxFillerTextView    fillerTextView_Close;
    public RtxFillerTextView    fillerTextView_Cancel;

    public RtxDialog_TargetClose_Layout(Context context) {
        super(context);
    ...
    {
        {
            ...
            if(fillerTextView_Close == null)        { fillerTextView_Close = new RtxFillerTextView(mContext);   }
    ...
    private void add_View()
    {
        ...
        addRtxTextViewToLayout(textView_Description, R.string.close_description, 28f, Common.Color.white, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, -1, 128 - 50, 1002, 20 + 100);

        addRtxTextViewToLayout(fillerTextView_Close, R.string.end_now, 28f, Common.Color.login_word_dark_black, Common.Font.KatahdinRound, Typeface.NORMAL, Gravity.CENTER, -1, 223, 378, 75, Common.Color.red_1);
