    ...
    public View getView(int position, View convertView, ViewGroup parent) {
...

        {
            ...
            if(iCompare >= 0)
            {
                ...
                if(cDay.compareTo(cDayMax) >= 0)
                {
                    if(!Rtx_Calendar.isSameDate(cDay,GlobalData.getInstance()))
                    {
                        dayView.setTextColor(Common.Color.gray_5);  //set white color to current day text
                    }
