 ...
 */
public class RtxCircularDirectSeekBar extends View {
...
//    protected static final float DEFAULT_END_ANGLE = 360f; // Geometric (clockwise, relative to 3 o'clock)
    ...
    protected float[][] mMarkLinePositionXY = new float[12][2];
    protected float[][] mMarkLineStartPositionXY = new float[12][2];
    protected float[][] mMarkLineEndPositionXY = new float[12][2];
    ...
    protected void calculateMarkLinePointerXYPosition()
    {
        ...
        int iIndex = 0;
        float fPartLen = pm.getLength() / 12;
        float fLen = 0;
...
//                    lastCWDistanceFromStart = cwDistanceFromStart;
    ...
    public RtxCircularDirectSeekBar(Context context) {
        super(context);
        init();
    }
    ...
    public interface OnCircularSeekBarChangeListener {
        ...
        public abstract void onProgressChanged(RtxCircularDirectSeekBar circularSeekBar, int progress, boolean fromUser);

        public abstract void onStopTrackingTouch(RtxCircularDirectSeekBar seekBar);

        public abstract void onStartTrackingTouch(RtxCircularDirectSeekBar seekBar);
    }
