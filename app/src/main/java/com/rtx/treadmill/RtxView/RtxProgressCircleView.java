 ...
 */
public class RtxProgressCircleView extends View {
    ...
    public RtxProgressCircleView(Context context) {
        super(context);
    ...
    public RtxProgressCircleView(Context context, float fStart , float fTarget) {
        super(context);
    ...
    public RtxProgressCircleView(Context context, float fStart , float fTarget , float fVal) {
        super(context);
    ...
    public void init()
    {
        ...
        mOutSidePaint.setColor(0xff585870); //设置进度条颜色
        ...
        mInSidePaint.setColor(0xfffbf000); //设置进度条颜色
    ...
    private void vDrawDirect(Canvas canvas)
    {
...

        {
            ...
            mLinePaint.setColor(0xfffbf000);
    ...
    private void vDrawValCicle(Canvas canvas)
    {
        ...
        if(fStartVal < fTargetVal)
        {
            ...
            if(fCurrentVal < fStartVal)
            {
                mInSidePaint.setColor(0xFF4FECBE);
            }
            else
            if(fCurrentVal > fTargetVal)
            {
                mInSidePaint.setColor(0xFFFF5050);
            }
            else
            {
                mInSidePaint.setColor(0xFFFBF000);
            }
        ...
        else
        {
            ...
            if(fCurrentVal < fTargetVal)
            {
                mInSidePaint.setColor(0xFF4FECBE);//green
            }
            else
            if(fCurrentVal > fStartVal)
            {
                mInSidePaint.setColor(0xFFFF5050);//red
            }
            else
            {
                mInSidePaint.setColor(0xFFFBF000);//yellow
            }
