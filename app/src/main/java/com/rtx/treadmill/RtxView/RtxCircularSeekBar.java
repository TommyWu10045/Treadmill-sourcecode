 ...
 */
public class RtxCircularSeekBar extends RtxImageView {
    ...
    protected static final float DEFAULT_POINTER_RADIUS = 32f;
    ...
    protected static final float DEFAULT_CIRCLE_STROKE_WIDTH = 15f;
...
//    protected static final float DEFAULT_END_ANGLE = 360f; // Geometric (clockwise, relative to 3 o'clock)
    ...
    protected void Create_Bitmap(Canvas canvas) {
        ...
        canvas.drawPath(mCirclePath, mCircleProgressGlowPaint);
    ...
    public void setEndAngle(float fAngle)
    {
        mEndAngle = fAngle;
    }

    public void setCircleStrokeWidth(float fWidth)
    {
        mCircleStrokeWidth = fWidth;
        mCirclePaint.setStrokeWidth(mCircleStrokeWidth);
        mCircleProgressPaint.setStrokeWidth(mCircleStrokeWidth);
    }

    public void setPointRadius(float fWidth)
    {
        mPointerRadius = fWidth;
    }
    /**
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float x = event.getX() - iW / 2;
        float y = event.getY() - iH / 2;
...
//                    lastCWDistanceFromStart = cwDistanceFromStart;
    ...
    public RtxCircularSeekBar(Context context) {
        super(context, 0);
        init();
    }
    ...
    public interface OnCircularSeekBarChangeListener {
        ...
        public abstract void onProgressChanged(RtxCircularSeekBar circularSeekBar, int progress, boolean fromUser);

        public abstract void onStopTrackingTouch(RtxCircularSeekBar seekBar);

        public abstract void onStartTrackingTouch(RtxCircularSeekBar seekBar);
    }
    ...
    public void setCircleColor(int[] color, int ix, int iy, int iw, int ih, Shader.TileMode tile) {
        Shader mShader = new LinearGradient(ix, iy, iw, ih, color, null, tile);
