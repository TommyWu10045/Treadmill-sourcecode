 ...
 */
public class RtxSimpleBike extends Rtx_BaseLayout {
    ...
    private int i_item_quickstart[][] = {//item , item_list choice(default) , icon, arrow for normal
            {0, 0, R.drawable.distance_01        , 1 }, //item0
            {1, 0, R.drawable.tr_calories_icon   , 1 }, //item1
            {2, 0, R.drawable.hrc_heart          , 1 }, //item2
            {3, 0, R.drawable.tr_time_icon       , 1 }  //item3
    };

    private int i_item_list_quickstart[][] = {//item choice name for normal
            {R.string.ellipse_time},
            {R.string.distance, R.string.speed, R.string.avg_speed, R.string.watt},
    ...
    private int i_item_list_calories[][] = {//item choice name for calories
            ...
            {R.string.ellipse_time},
            {R.string.distance, R.string.speed, R.string.avg_speed, R.string.watt},
            {R.string.heart_rate, R.string.avg_heart_rate, R.string.mets}
    };
    ...
    private int i_item_list_distance[][] = {//item choice name for distance
            {R.string.distance},
            {R.string.ellipse_time, R.string.speed, R.string.avg_speed, R.string.watt},
            {R.string.calories, R.string.calories_hour, R.string.mets},
            {R.string.heart_rate, R.string.avg_heart_rate}
    };
    ...
    ///////////target is watt/////////
    private int i_item_watt[][] = {//item , choice , icon, arrow for distance
            {0, 0, R.drawable.distance_01        , 0 }, //Distance
            {1, 0, R.drawable.tr_calories_icon   , 0 }, //Calories
            {2, 0, R.drawable.hrc_heart          , 0 }, //HeartRate
            {3, 0, R.drawable.tr_time_icon       , 0 }  //Time
    ...
    private int i_item_list_watt[][] = {//item choice name for distance
            {R.string.watt},
            {R.string.ellipse_time, R.string.speed, R.string.avg_speed},
            {R.string.distance, R.string.calories, R.string.calories_hour, R.string.mets},
            {R.string.heart_rate, R.string.avg_heart_rate}
    };

    private int i_val_list_watt[][] = {//item choice value for distance
            {0x16},
            {0x40, 0x14, 0x15 },
            {0x10, 0x20, 0x21, 0x22 },
            {0x30, 0x32 }
    ...
    private int i_item_list_heartrate[][] = {//item choice name for heartrate
            {R.string.heart_rate},
            {R.string.distance, R.string.rpm, R.string.speed, R.string.avg_speed},
            {R.string.calories, R.string.calories_hour, R.string.watt, R.string.mets},
            {R.string.ellipse_time,R.string.remaining_time}
    };
    ...
    public RtxSimpleBike(Context context, MainActivity mMainActivity){
        super(context);
    ...
    private boolean bSet_mode_style_parameter( )
    {
        ...
        switch (itarget_mode)
        {
            ...
            case 5: //normal no remainint time
                ...
                break;
            case 6: //watt
                i_item_data = i_item_watt ;
                i_choice_list = i_item_list_watt;
                i_choice_val = i_val_list_watt;
