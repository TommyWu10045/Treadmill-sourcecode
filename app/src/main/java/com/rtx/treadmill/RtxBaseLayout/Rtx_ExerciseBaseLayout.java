...
public class Rtx_ExerciseBaseLayout extends Rtx_BaseLayout {
    ...
    private int[] i_strlist = { R.string.profile, R.string.simple, R.string.lap};
    int imax = i_strlist.length;

    public Rtx_ExerciseBaseLayout(Context context, MainActivity mMainActivity) {
        super(context);
