...
public class Rtx_BaseLayoutE extends FrameLayout
{
    Context mContext;
    ...
    public RtxImageView    imageView_ReturnExercisePage;
    private RtxView         view_TopBlockBackground;
    public  RtxView         view_Background;

    public Rtx_BaseLayoutE(Context context) {
        super(context);
    ...
    public void init_BackHome()
    {
        ...
        addRtxImagePaddingViewToLayout(imageView_BackHome, R.xml.home, 1050, 38, 39, 39, 50);
    }

    public void init_BackExercise()
    {
        if(imageView_ReturnExercisePage == null)    {   imageView_ReturnExercisePage = new RtxImageView(mContext);  }
        addRtxImagePaddingViewToLayout(imageView_ReturnExercisePage, R.drawable.home_return_exercise, 1151, 35, 51, 46, 60);
    }
    ...
    public void init_Title()
    {
        ...
        addRtxTextViewToLayout(textView_Title, 28.00f, Common.Color.main_word_white, Common.Font.KatahdinRound, Typeface.NORMAL, Gravity.CENTER, 0, 35, 1280, 37);//By Alan
    }

    public void init_SubTitle()
    {
        if(textView_SubTitle == null)   { textView_SubTitle = new RtxTextView(mContext); }
        addRtxTextViewToLayout(textView_SubTitle, 29.68f, Common.Color.login_word_blue, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, 0, 133, 1280, 36);
    }
    ...
    public void addViewToLayout(View view , int iX , int iY , int iWidth , int iHeight)
    {
        ...
        if(iY == -1)
        {
            mLayoutParams.gravity = Gravity.CENTER_VERTICAL | Gravity.TOP;
    ...
    public void addRtxImage(FrameLayout mFrame, RtxImageView view , int iResID , int iX , int iY , int iWidth , int iHeight , int iPadding , ImageView.ScaleType scaletype) {
        ...
        {
            addPaddingViewToLayout(mFrame, view, iX, iY, iWidth, iHeight, iPadding);
        }
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void addRtxDoubleStringView(FrameLayout mFrame, RtxDoubleStringView view, int iX, int iY, int iWidth, int iHeight) {
    ...
    public void vRtxBaseLayoutE_SetShareView(RtxImageView mRtxImageView) {
        ...
        {
            mRtxImageView.setVisibility(VISIBLE);
        }
        else
        {
            mRtxImageView.setVisibility(INVISIBLE);
        }
    }
    ...
    public void vRtxBaseLayoutE_SetShareView(RtxTextView mRtxTextView) {
        if(Rtx_Debug.bRtxDebug_GetShareEnable())
        {
            mRtxTextView.setVisibility(VISIBLE);
        }
        else
        {
            mRtxTextView.setVisibility(INVISIBLE);
        }
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
