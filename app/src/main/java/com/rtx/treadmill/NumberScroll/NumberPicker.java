...
package com.rtx.treadmill.NumberScroll;
...
public class NumberPicker extends LinearLayout {
    private static String TAG = "Tom===NumberPicker";
    private static boolean DEBUG = false;

    private static boolean RTX_style = false;//true : only draw middle
    /**
    ...
    private int iMoveY_scale = 1;
    private int iMoveY_speed_scale = 4;
    ...
    private final int mWheelSolidColor;
    ...
    public NumberPicker(Context context) {
        this(context, null);
        if (DEBUG) Log.d(TAG, "NumberPicker-----00");
    }
    ...
    public NumberPicker(Context context, AttributeSet attrs) {
        ...
        if (DEBUG) Log.d(TAG, "NumberPicker-----01");
    }
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        if (DEBUG) Log.d(TAG, "NumberPicker-----02");

        // process style attributes
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.NumberPicker, defStyle, R.style.NPWidgetdef);
        ...
        mWheelSolidColor = attributesArray.getColor(R.styleable.NumberPicker_wheelsolidColor, 0);
...
//            mDecrementButton.setOnLongClickListener(onLongClickListener);
        ...
        paint1.setTypeface(mInputText.getTypeface());
        paint1.setColor(mWheelSolidColor);
        mSelectorWheelMiddlePaint = paint1;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                int initialVelocity = (int) velocityTracker.getYVelocity() * iMoveY_speed_scale;
    ...
    public void scrollBy(int x, int y) {
        ...
        while (mCurrentScrollOffset - mInitialScrollOffset > mSelectorTextGapHeight) {
            ...
            if(mCurrentScrollOffset > mInitialScrollOffset * 5)
            {
                mCurrentScrollOffset = mInitialScrollOffset;
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            // with the new one.
            if(i == SELECTOR_MIDDLE_ITEM_INDEX || !RTX_style)
            {
                if(i == SELECTOR_MIDDLE_ITEM_INDEX && mScrollState == OnScrollListener.SCROLL_STATE_IDLE
                         && mCurrentScrollOffset <= mInitialScrollOffset)
                {
                    canvas.drawText(scrollSelectorValue, x, y, mSelectorWheelMiddlePaint);
                }
    ...
    private boolean updateInputTextView() {
        ...
        if (!TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString())) {
            mInputText.setTextSize(mTextSize);
            mInputText.setTextColor(mWheelSolidColor);
    ...
    public void v_set_MoveY_scale(int MoveY_scale)
    {
        iMoveY_scale = MoveY_scale;
    }
