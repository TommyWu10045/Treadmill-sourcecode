...
import com.rtx.treadmill.RtxMainFunctionBike.BodyManager.BodyManagerState;
import com.rtx.treadmill.RtxMainFunctionBike.HeartRate.HeartRateState;
import com.rtx.treadmill.RtxMainFunctionBike.Hiit.HiitState;
import com.rtx.treadmill.RtxMainFunctionBike.Login.LoginState;
import com.rtx.treadmill.RtxMainFunctionBike.MyGym.MyGymState;
import com.rtx.treadmill.RtxMainFunctionBike.MyWorkout.MyWorkoutState;
import com.rtx.treadmill.RtxMainFunctionBike.Performance.PerformanceState;
import com.rtx.treadmill.RtxMainFunctionBike.Physical.PhysicalState;
import com.rtx.treadmill.RtxMainFunctionBike.QuickStart.QuickStartState;
import com.rtx.treadmill.RtxMainFunctionBike.Setting.SettingState;
import com.rtx.treadmill.RtxMainFunctionBike.TargetTrain.TargetTrainState;
import com.rtx.treadmill.RtxMainFunctionBike.Training.TrainingState;
import com.rtx.treadmill.RtxMainFunctionBike.BodyManager.BodyManagerProc;
import com.rtx.treadmill.RtxMainFunctionBike.Exercise.Bottominfo.BottomInfoProc;
import com.rtx.treadmill.RtxMainFunctionBike.Exercise.ChoiceItem.ChoiceItemProc;
import com.rtx.treadmill.RtxMainFunctionBike.Exercise.ExerciseProc;
import com.rtx.treadmill.RtxMainFunctionBike.Exercise.Info.InfoProc;
import com.rtx.treadmill.RtxMainFunctionBike.HeartRate.HeartRateProc;
import com.rtx.treadmill.RtxMainFunctionBike.Hiit.HiitProc;
import com.rtx.treadmill.RtxMainFunctionBike.Home.HomeProc;
import com.rtx.treadmill.RtxMainFunctionBike.Home.HomeState;
import com.rtx.treadmill.RtxMainFunctionBike.Home.HomeLayout;
import com.rtx.treadmill.RtxMainFunctionBike.Login.LoginProc;
import com.rtx.treadmill.RtxMainFunctionBike.MyGym.MyGymProc;
import com.rtx.treadmill.RtxMainFunctionBike.MyWorkout.MyWorkoutProc;
import com.rtx.treadmill.RtxMainFunctionBike.Performance.PerformanceProc;
import com.rtx.treadmill.RtxMainFunctionBike.Physical.PhysicalProc;
import com.rtx.treadmill.RtxMainFunctionBike.QuickStart.QuickStartProc;
import com.rtx.treadmill.RtxMainFunctionBike.Setting.SettingProc;
import com.rtx.treadmill.RtxMainFunctionBike.TargetTrain.TargetTrainProc;
import com.rtx.treadmill.RtxMainFunctionBike.Training.TrainingProc;
...
public class MainProcBike extends Thread {
...
//    private static final int DEF_SEC_COUNT = 1000 / DEF_UNIT_TIME;
    ...
    private boolean     Physical_Start_Bt   = true;
    ...
    public MainProcBike(MainActivity mMainActivity) {
    ...
    private void vSet_Machine_Uart_Data()
    {
        ...
        UartData.set_uart_limit_bike(EngSetting.f_Get_Max_level());
    ...
    private void vProc_Engmode() {
        ...
        Log.e(TAG, "mMainProcBike vProc_Engmode");
    ...
    public void v_Goto_ExercisePage()
    {
        ...
        {
            case PROC_HOME                  : { homeProc.vSetNextState(HomeState.PROC_EXIT);                 break ; }
            case PROC_LOGIN                 : { loginProc.vSetNextState(LoginState.PROC_EXIT);               break ; }
        ...
        if(bchange) {
            switch (imode) {
                case PROC_EXERCISE_TR:
                    ...
                    mMainActivity.mMainProcBike.trainingProc.vSetNextState(TrainingState.PROC_EXERCISE_SHOW);
                    break;

                case PROC_EXERCISE_HEARTRATE:
                    mMainActivity.mMainProcBike.vSetNextState(MainState.PROC_HEART_RATE_CONTROL);
                    mMainActivity.mMainProcBike.heartrateProc.vSetNextState(HeartRateState.PROC_EXERCISE_SHOW);
                    break;

                case PROC_EXERCISE_WORKOUT:
                    mMainActivity.mMainProcBike.vSetNextState(MainState.PROC_MY_WORKOUT);
                    mMainActivity.mMainProcBike.myWorkoutProc.vSetNextState(MyWorkoutState.PROC_EXERCISE_SHOW);
                    break;

                case PROC_EXERCISE_QUICKSTART:
                    mMainActivity.mMainProcBike.vSetNextState(MainState.PROC_QUICK_START);
                    mMainActivity.mMainProcBike.quickStartProc.vSetNextState(QuickStartState.PROC_EXERCISE_SHOW);
                    break;
                default:
                    break;
            }
    ...
    public void run() {
        ...
        try {
            while ( bRun ) {
                ...
                {
//                    Log.e("Jerry", "-------------------------------------------------------");
//                    Log.e("Jerry", "[MainProc] mState = " + mState);
                    tempState = mState;
                }
                ...
                switch( mState )
                {
                    ...
                    case PROC_LOGIN                 : { vProc_Login()           ;       break ; }
