...
public class RegHeightLayout extends Rtx_NumKeyboard_Height_BaseLayout {
    ...
    {
        mMainActivity.mMainProcBike.loginProc.vSetNextState(LoginState.PROC_SHOW_PAGE_REG_GENDER);
    }
    ...
    public void vClickButton_Confirm()
    {
        ...
        mMainActivity.mMainProcBike.loginProc.vSetNextState(LoginState.PROC_SHOW_PAGE_REG_BIRTHDAY);
    }
