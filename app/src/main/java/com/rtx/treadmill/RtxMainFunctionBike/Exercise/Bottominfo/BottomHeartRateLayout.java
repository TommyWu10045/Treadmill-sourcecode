 ...
 */
public class BottomHeartRateLayout extends Rtx_BaseLayout {
    ...
    private int itarget_mode = 4; //1 time; 2 distance; 3 calories; 4 heartrate; 6 watt
    ...
    private int i_item_data[][] = {//item , choice , icon, arrow
            {0, 0, R.drawable.distance_01       , 0 }, //Pace and Distance
            {1, 0, R.drawable.tr_time_icon      , 0 }, //Time
    ...
    private int i_choice_list[][] = {//item choice name for normal
            ...
            {R.string.distance, R.string.speed, R.string.avg_speed, R.string.rpm},
    ...
    public BottomHeartRateLayout(Context context, MainActivity mMainActivity){
        super(context);
