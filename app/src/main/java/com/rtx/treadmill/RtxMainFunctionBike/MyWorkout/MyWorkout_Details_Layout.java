...
public class MyWorkout_Details_Layout extends Rtx_BaseLayout {
    ...
    private void add_View()
    {
        ...
        addRtxImagePaddingViewToLayout(imageView_Icon_5st, R.drawable.workout_details_avg_watt, 814, 504, 54, 54, 0);
        ...
        addRtxTextViewToLayout(textView_Item_4st, R.string.avg_speed , 20.07f, Common.Color.blue_1, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, 276, 679 - 25, 362, 21 + 50);
        addRtxTextViewToLayout(textView_Item_5st, R.string.avg_watt, 20.07f, Common.Color.blue_1, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, 666, 679 - 25, 362, 21 + 50);
    }
    ...
    protected void vSetWorkoutItemInfo(UiDataStruct.WORKOUT_ITEM_INFO workoutItem)
    {
...

        {
            ...
            String sDistance_60 = null;
            String sCalories_60 = null;
            String sAvgSpeed = null;
            String sAvgWatt = null;

            sDuration = new String(Rtx_Calendar.sMin2Str(workoutItem.iGetTotalMin(),null));
            sDistance_60 = new String(Rtx_TranslateValue.sFloat2String(workoutItem.fGetDistance(60),1));
            sCalories_60 = new String(Rtx_TranslateValue.sInt2String(workoutItem.iGetCalories(CloudDataStruct.CloudData_17.f_get_user_weight(),60)));
            sAvgSpeed = new String(Rtx_TranslateValue.sFloat2String(workoutItem.fGetAvgSpeed(60),1));
            sAvgWatt = new String(Rtx_TranslateValue.sFloat2String(workoutItem.fGetAvgWatt(60),1));

            vSetInfo(sDuration,sDistance_60,sCalories_60,sAvgSpeed,sAvgWatt);
        }


    }

    protected void vSetInfo(String sDuration, String sDistance_60, String sCalories_60, String sAvgSpeed, String sAvgWatt)
    {
        doubleStringView_Val_1st.setText(sDuration,"");
        doubleStringView_Val_2st.setText(sDistance_60, EngSetting.Distance.getUnitString(mContext));
        doubleStringView_Val_3st.setText(sCalories_60, LanguageData.s_get_string(mContext,R.string.kcal));
        doubleStringView_Val_4st.setText(sAvgSpeed,EngSetting.Distance.getSpeedUnitLowerString(mContext));
        doubleStringView_Val_5st.setText(sAvgWatt,"");
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
