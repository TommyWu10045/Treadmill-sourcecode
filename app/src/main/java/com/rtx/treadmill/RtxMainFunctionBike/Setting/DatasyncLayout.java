...
//            {R.string.jawbone,      R.drawable.session_jawbone,     6,  0,  0,  0,  0},
    ...
    private void v_check_app_on(int isel)
    {
        ...
        if(ifitness_list[isel][5] == 0)
        {
            ...
            mMainActivity.mMainProcBike.settingProc.vSet_trd_pty_app(ifitness_list[isel][2]);
            mMainActivity.mMainProcBike.settingProc.vSet_trd_of("1");
            mMainActivity.mMainProcBike.settingProc.vSet_trd_id("");
            mMainActivity.mMainProcBike.settingProc.vSet_trd_pw("");
            ...
            switch (ifitness_list[isel][2])
            {
                ...
                case 2:
                    mMainActivity.mMainProcBike.settingProc.vSetNextState(SettingState.PROC_SHOW_DATASYNC_GOOGLE);
                    break;

                case 3:
                    mMainActivity.mMainProcBike.settingProc.vSetNextState(SettingState.PROC_SHOW_DATASYNC_MYMAP);
                    break;

                case 4:
                    mMainActivity.mMainProcBike.settingProc.vSetNextState(SettingState.PROC_SHOW_DATASYNC_RUNKEEPER);
                    break;

                case 5:
                    mMainActivity.mMainProcBike.settingProc.vSetNextState(SettingState.PROC_SHOW_DATASYNC_FITBIT);
                    break;

                case 6:
                    mMainActivity.mMainProcBike.settingProc.vSetNextState(SettingState.PROC_SHOW_DATASYNC_JAWBONE);
                    break;

                case 7:
                    mMainActivity.mMainProcBike.settingProc.vSetNextState(SettingState.PROC_SHOW_DATASYNC_GARMIN);
                    break;
    ...
    private void v_check_app_off(int isel)
    {
        ...
        if(ifitness_list[isel][5] == 1)
        {
            ...
            mMainActivity.mMainProcBike.settingProc.vSet_trd_pty_app(ifitness_list[isel][2]);
            mMainActivity.mMainProcBike.settingProc.vSet_trd_of("0");
            mMainActivity.mMainProcBike.settingProc.vSet_trd_id("");
            mMainActivity.mMainProcBike.settingProc.vSet_trd_pw("");
