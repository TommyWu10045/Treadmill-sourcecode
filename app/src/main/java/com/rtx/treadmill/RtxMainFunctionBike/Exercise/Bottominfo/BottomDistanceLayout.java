 ...
 */
public class BottomDistanceLayout extends Rtx_BaseLayout {
    ...
    private int itarget_mode = 2; //1 time; 2 distance; 3 calories; 4 heartrate; 6 watt
    ...
    private int i_item_data[][] = {//item , choice , icon, arrow
            ...
            {1, 0, R.drawable.tr_calories_icon  , 0 }, //Pace
            {2, 0, R.drawable.tr_time_icon      , 0 }, //Time and Calories
            {3, 0, R.drawable.distance_01       , 0 }, // Distance
    ...
    private int i_choice_list[][] = {//item choice name for normal
            ...
            {R.string.ellipse_time, R.string.speed, R.string.avg_speed, R.string.rpm, R.string.watt},
            {R.string.distance},
    };
    ...
    public BottomDistanceLayout(Context context, MainActivity mMainActivity){
        super(context);
