...
public class MyWorkoutLayout extends Rtx_BaseLayout {
    ...
    private void init_View()
    {
...

        {
            ...
            if(simplePreview_1st == null)               { simplePreview_1st = new RtxExerciseSimplePreview(mContext,1); }
            if(simplePreview_2st == null)               { simplePreview_2st = new RtxExerciseSimplePreview(mContext,1); }
            if(simplePreview_3st == null)               { simplePreview_3st = new RtxExerciseSimplePreview(mContext,1); }
        }
    }
        ...
        else
        {
            ...
            mMainActivity.dialogLayout_Login.fillerTextView_Login.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    mMainActivity.mMainProcBike.myWorkoutProc.vMainChangePage(MainState.PROC_LOGIN);
...
//          setCreateButtonState(0);
    ...
    {
        mMainActivity.mMainProcBike.myWorkoutProc.vMainChangePage(MainState.PROC_HOME);
    }
    ...
    private void vShowInfoDialog()
    {
        ...
        String sinfo01 = LanguageData.s_get_string(mContext, R.string.workout_info_bk).toUpperCase();

        Dialog_UI_Info.v_tist_Dialog(R.drawable.main_icon_my_workout, -1, stitle01, null, sinfo01, null, "mw_information_bk", ImageView.ScaleType.FIT_XY);
    ...
    private void vClickCreateButton()
    {
        ...
        mMainActivity.mMainProcBike.myWorkoutProc.vSetMode(MODE_CREATE);
        mMainActivity.mMainProcBike.myWorkoutProc.vSetSelectItemIndex(-1);
    }
    ...
    private void vClickItem(int iIndex)
    {
        ...
        mMainActivity.mMainProcBike.myWorkoutProc.vSetSelectItemIndex(iIndex);
    }
