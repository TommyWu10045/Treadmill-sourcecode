...
public class MainLayout extends Rtx_BaseLayout {
    ...
    {
        int iLoop ;
        istr_list = mMainActivity.mMainProcBike.heartrateProc.itype_list;
        sinfo_list = mMainActivity.mMainProcBike.heartrateProc.sinfolist;
...
//        icon
        ...
        fsize = 28f;
        for(iLoop = 0; iLoop < imax; iLoop++) {
            addRtxTextViewToLayout(t_date[iLoop], istr_list[iLoop][1], fsize, Common.Color.bd_word_white, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, ix, iy, iw, ih);
            ix += ix_shift;
        }
    ...
    {
        mMainActivity.mMainProcBike.heartrateProc.vSet_Select(iLoop);
