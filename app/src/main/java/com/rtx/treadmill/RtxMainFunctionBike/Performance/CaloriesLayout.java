...
public class CaloriesLayout extends Rtx_CircularSeekBar_BaseLayout {
    ...
    {
        mMainActivity.mMainProcBike.performanceProc.vSet_calories(getCurrentVal());
        mMainActivity.mMainProcBike.performanceProc.vSetNextState(PerformanceState.PROC_CLOUD_PF_ADD_SESSION);
    }
