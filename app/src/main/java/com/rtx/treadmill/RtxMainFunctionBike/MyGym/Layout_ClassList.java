...

                {
                    ...
                    blockViewInfo.view.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            mMainActivity.mMainProcBike.myGymProc.vSetDetailDate(finalBlockViewInfo.cal_StartTime);
                            mMainActivity.mMainProcBike.myGymProc.vSetClassID(finalBlockViewInfo.sCLS_ID);
                            mMainActivity.mMainProcBike.myGymProc.vSetBkgSeq(finalBlockViewInfo.sBKG_SEQ);
                            mMainActivity.mMainProcBike.myGymProc.vSetNextState(MyGymState.PROC_SHOW_PAGE_CLASS_DETAIL);
