...
public class BottomLayout extends Rtx_BaseLayout {
    ...
    private BottomWattLayout mBottomWattLayout;
    ...
    private void init_View() {
        ...
        if(mBottomWattLayout == null)                { mBottomWattLayout = new BottomWattLayout(mMainActivity.mContext , mMainActivity); }
    ...
    private void add_View()
    {
        ...
        switch (itarget_mode)
        {
            ...
            case 7: //manual time
                ...
                break;
            case 6: //watt
                addViewToLayout(mBottomWattLayout, ix, iy, iw, ih);
                mBottomWattLayout.init(fscale);
                break;
            default:
                break;
        }
    ...
    public void vUpdate_Data()
    {
        switch (itarget_mode)
        {
            ...
            case 7: //manual time
                ...
                break;
            case 6: //watt
                if(mBottomWattLayout != null) {
                    mBottomWattLayout.Refresh();
                }
                break;
            default:
