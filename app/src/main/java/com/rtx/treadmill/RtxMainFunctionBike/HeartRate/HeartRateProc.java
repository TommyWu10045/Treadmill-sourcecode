...
public class HeartRateProc {
    ...
    public int itype_list[][] = {
            ...
            { R.drawable.hrc_aerobic,       R.string.aerobic,       R.drawable.hrc_fatburn,     R.string.hrc_info_aerobic                },
            { R.drawable.hrc_performance,   R.string.performance,   R.drawable.hrc_fatburn,     R.string.hrc_info_performance                },
            { R.drawable.hrc_customize,     R.string.customize,     R.drawable.hrc_fatburn,     R.string.hrc_info_customize                }
    };
    ...
    {
        mMainActivity.mMainProcBike.heartrateProc.vSetNextState(HeartRateState.PROC_EXIT);
    ...
    public void vReturnMainProc()
    {
        ...
        {
            mMainActivity.mMainProcBike.loginProc.vMainChangePage(mMainActivity.mMainProcBike.vGetBeforeLoginState());
