...
public class WeightLayout extends Rtx_NumberWheel_Weight_BaseLayout {
    ...
    {
        mMainActivity.mMainProcBike.trainingProc.vSetNextState(TrainingState.PROC_SHOW_TRAINING);
    }
    ...
    public void vClickButton_Confirm()
    {
        ...
        mMainActivity.mMainProcBike.trainingProc.vSet_weight(getCurrentVal_Metric());
