 ...
 */
public class BottomWattLayout extends Rtx_BaseLayout {
    ...
    private int itarget_mode = 6; //1 time; 2 distance; 3 calories; 4 heartrate; 6 watt
    ...
    private int i_choice_list[][] = {//item choice name for normal
            {R.string.heart_rate, R.string.avg_heart_rate, R.string.calories, R.string.calories_hour},
            {R.string.distance, R.string.speed, R.string.avg_speed, R.string.rpm, R.string.watt, R.string.mets},
    ...
    public BottomWattLayout(Context context, MainActivity mMainActivity){
        super(context);
