...
//      age icon
        ...
        iy += ih;
        ih = 60;
        sdata = com.rtx.treadmill.RtxMainFunction.HeartRate.HeartRateFunc.get_unit(mContext, R.string.years);
...
//      weight icon
        ...
        iy += ih;
        ih = 60;
        sdata = com.rtx.treadmill.RtxMainFunction.HeartRate.HeartRateFunc.get_mass_unit(mContext);
        addRtxTextViewToLayout(t_unit[iLoop], sdata.toLowerCase(), fsize_unit, Common.Color.hrc_word_blue, Common.Font.Relay_BoldItalic, Typeface.NORMAL, Gravity.CENTER, ix, iy, iw, ih);
...
//      time icon
        ...
        iy += ih;
        ih = 60;
        sdata = com.rtx.treadmill.RtxMainFunction.HeartRate.HeartRateFunc.get_unit(mContext, R.string.min);
        addRtxTextViewToLayout(t_unit[iLoop], sdata.toLowerCase(), fsize_unit, Common.Color.hrc_word_blue, Common.Font.Relay_BoldItalic, Typeface.NORMAL, Gravity.CENTER, ix, iy, iw, ih);
...
//      heart icon
        ...
        iy += ih;
        ih = 60;
        sdata = com.rtx.treadmill.RtxMainFunction.HeartRate.HeartRateFunc.get_unit(mContext, R.string.bpm);
        addRtxTextViewToLayout(t_unit[iLoop], sdata.toLowerCase(), fsize_unit, Common.Color.hrc_word_blue, Common.Font.Relay_BoldItalic, Typeface.NORMAL, Gravity.CENTER, ix, iy, iw, ih);
    ...
    {
        int iLoop;
        int imode = mMainActivity.mMainProcBike.heartrateProc.i_Get_mode();
        int[] idata;
        ...
        mMainActivity.mMainProcBike.heartrateProc.vSetNextState(HeartRateState.PROC_EXERCISE_CHECK_COUNTDOWN);
