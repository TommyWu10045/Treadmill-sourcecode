...
public class TargetTrainHistory_Block extends Rtx_BaseLayout {
    ...
    private void vDelete()
    {
        ...
        mMainActivity.mMainProcBike.targetTrainProc.vSetGoalSeq(cloud_TargetGoalClose.sGOL_SEQ);
        mMainActivity.mMainProcBike.targetTrainProc.vSetNextState(TargetTrainState.PROC_CLOUD_DELETE_GOAL_CLOSE);
    }
