 ...
 */
public class BottomCaloriesLayout extends Rtx_BaseLayout {
    ...
    private int itarget_mode = 3; //1 time; 2 distance; 3 calories; 4 heartrate; 6 watt
    ...
    public BottomCaloriesLayout(Context context, MainActivity mMainActivity){
        super(context);
