...
public class TrainingProc {
    ...
    private GoWattLayout  mGoWattLayout                ;
    private WattLayout  mWattLayout                   ;
    ...
    public int itype_tread_list[][] = {
            ...
            { R.drawable.tr_rolling            ,           R.string.rolling_hill       ,                  R.drawable.tr_rolling_icon      ,    R.string.tr_rolling_hill_info              },
            { R.drawable.tr_mountain          ,         R.string.mountain_peak       ,                R.drawable.tr_mountain_icon      ,    R.string.tr_mountains_peak_info               },
            { R.drawable.tr_fatburn         ,        R.string.fatburn       ,               R.drawable.tr_fatburn_icon      ,    R.string.tr_fatburn_info               },
            { R.drawable.tr_incline          ,         R.string.incline       ,                R.drawable.tr_incline_icon      ,    R.string.tr_incline_info              },
            ...
            { R.drawable.tr_constant            ,           R.string.constant_watt       ,                  R.drawable.tr_constant_icon      ,    R.string.tr_constant_watt_info              },
    };

    public String[] sinfotreadlist = {
            "tr_manual"       ,       "tr_hill"       ,       "tr_mountain"       ,       "tr_fatburn"       ,       "tr_incline"       ,       "tr_strength"       ,       "tr_interval"   ,       "tr_constant"
    };
...
//    2 : hard
    ...
    public TrainingProc(MainActivity mMainActivity) {
        ...
        if(mGoWattLayout          == null) { mGoWattLayout         =  new GoWattLayout             (mMainActivity.mContext, mMainActivity);}
        if(mWattLayout          == null) { mWattLayout         =  new WattLayout             (mMainActivity.mContext, mMainActivity);}
    ...
    public void vSet_Watt(float fval)
    {
        this.fwatt = fval;
    }
    /* ------------------------------------------------------------------------ */
    ...
    private void vProc_ShowPage_watt() {

        vChangeDisplayPage(mWattLayout);
    ...
    private void vProc_ShowPage_Go() {
        if(imode == 7) {
            mGoWattLayout.v_set_data(imode, fweight, ftarget, fwatt);
            vChangeDisplayPage(mGoWattLayout);
        }
        else {
    ...
    {
        mMainActivity.mMainProcBike.trainingProc.vSetNextState(TrainingState.PROC_EXIT);
    ...
    public void run() {
        ...
        switch( mState )
        {
            ...
            case PROC_SHOW_WATT                         :{   vProc_ShowPage_watt();                break;  }
