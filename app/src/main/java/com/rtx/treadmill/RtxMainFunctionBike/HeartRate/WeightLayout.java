...
public class WeightLayout extends Rtx_NumberWheel_Weight_BaseLayout {
    ...
    {
        mMainActivity.mMainProcBike.heartrateProc.vSetNextState(HeartRateState.PROC_SHOW_MAIN);
    }

    @Override
    public void vClickButton_Confirm()
    {
        mMainActivity.mMainProcBike.heartrateProc.fweight = getCurrentVal_Metric();
