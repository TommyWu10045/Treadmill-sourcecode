...
public enum TrainingState {
    ...
    PROC_SHOW_WATT                  (0x00000027) ,
    PROC_SHOW_DISTANCE_REFRESH      (0x00000028) ,

    PROC_EXERCISE_SHOW              (0x00000030) ,
    PROC_EXERCISE_INIT              (0x00000030) ,
    PROC_EXERCISE_REFRESH           (0x00000030) ,
    PROC_EXERCISE_TR_FINISH            (0x00000030) ,
