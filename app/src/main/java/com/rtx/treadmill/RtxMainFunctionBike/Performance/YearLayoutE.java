...
public class YearLayoutE extends Rtx_BaseLayoutE {
    ...
    private int istr_item_list[][] = {
            {R.string.distance   , Cloud_34_GET_EW_MON.Output.TTL_DST      },
            {R.string.duration   , Cloud_34_GET_EW_MON.Output.TTL_DRT      },
            {R.string.calories   , Cloud_34_GET_EW_MON.Output.TTL_CAL      },
            {R.string.pace       , Cloud_34_GET_EW_MON.Output.AVG_PAC      },
            {R.string.heart_rate , Cloud_34_GET_EW_MON.Output.AVG_HRT_RAT  },
            {R.string.watt       , Cloud_34_GET_EW_MON.Output.AVG_WAT      },
    };
    private int imax_item = istr_item_list.length;

    private int istr_list[][] = {
            {R.drawable.pf_distance_icon  ,  R.string.distance       , Cloud_26_GET_EW_YER.Output.TTL_DST        },
            {R.drawable.pf_duration_icon  ,  R.string.duration       , Cloud_26_GET_EW_YER.Output.TTL_DRT        },
            {R.drawable.pf_calories_icon  ,  R.string.calories       , Cloud_26_GET_EW_YER.Output.TTL_CAL        },
            {R.drawable.pf_pace_icon      ,  R.string.avg_pace       , Cloud_26_GET_EW_YER.Output.AVG_PAC        },
            {R.drawable.pf_hr_icon        ,  R.string.avg_heart_rate , Cloud_26_GET_EW_YER.Output.AVG_HRT_RAT    },
    };
    ...
    public YearLayoutE(Context context, MainActivity mMainActivity) {
        super(context);
...
//      prev and next icon
        ...
        iw = 820;
        ih = 270;
        addRtxImage(f_back, draw_image, R.drawable.pf_year_none, ix, iy, iw, ih, 0, null);
