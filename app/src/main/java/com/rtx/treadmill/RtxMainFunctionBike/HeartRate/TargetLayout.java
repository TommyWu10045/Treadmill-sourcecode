...
public class TargetLayout extends Rtx_CircularHeartRate_BaseLayout {
    ...
    {
        int imode = mMainActivity.mMainProcBike.heartrateProc.imode;
        int[] idata;
        float fage ;
    ...
    {
        mMainActivity.mMainProcBike.heartrateProc.ftarget = (float) getCurrentVal();
        mMainActivity.mMainProcBike.heartrateProc.vSetNextState(HeartRateState.PROC_SHOW_START);
    }
