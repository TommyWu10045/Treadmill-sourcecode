package com.rtx.treadmill.RtxMainFunctionBike.Exercise.ExerciseRun;
...
import com.rtx.treadmill.RtxMainFunctionBike.Exercise.Pause.PauseState;
...
public class ExerciseRunProc {
    ...
    private ExerciseRunState mState = ExerciseRunState.PROC_INIT ;
    ...
    private void vProc_Caculation() {
        ...
        {
            mMainActivity.mMainProcBike.exerciseProc.pauseProc.vSetNextState(PauseState.PROC_PAUSE_MODE2);
            vProc_Exit(ExerciseState.PROC_EXERCISE_PAUSE);
        }
        else if(ExerciseData.i_get_finish() == 0x11) //RPM is 0 timeout
        {
            mMainActivity.mMainProcBike.exerciseProc.pauseProc.vSetNextState(PauseState.PROC_PAUSE_RESET1);
            vProc_Exit(ExerciseState.PROC_EXERCISE_PAUSE);
        }
        else
        {
...
//        if(!Rtx_Debug.bGetRELEASE_MODE())
    ...
    private void vProc_Exit(ExerciseState mstate) {
        ...
        mMainActivity.mMainProcBike.exerciseProc.vSetNextState(mstate);
    ...
    public void run() {
        ...
        switch( mState )
        {
            ...
            case PROC_EXERCISE_PHY_GERKIN               :{   vProc_Phy_VO2();             break;  }
            ...
            case PROC_EXERCISE_TR_INCINE:                {   vProc_TraingCourse();           break;  }
            case PROC_EXERCISE_TR_MOUNTANT:              {   vProc_TraingCourse();           break;  }
            case PROC_EXERCISE_TR_CONSWATT:              {   vProc_TraingCourse();           break;  }
            ...
            case PROC_EXERCISE_GETSTATUS                :{   vProc_Uart16Cmd();              break;  }
