...
public class PasswordConfirmLayout extends PasswordLayout {
    ...
    public void vClickNext()
    {
        ...
        if(sdata.compareTo(mMainActivity.mMainProcBike.settingProc.spassword) == 0) {
            mMainActivity.mMainProcBike.settingProc.vSetNextState(SettingState.PROC_SHOW_CHANGEPASSWORD03);
        }
        else
        {
