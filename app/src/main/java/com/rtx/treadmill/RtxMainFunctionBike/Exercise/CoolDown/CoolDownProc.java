package com.rtx.treadmill.RtxMainFunctionBike.Exercise.CoolDown;
...
import com.rtx.treadmill.RtxMainFunctionBike.Exercise.CoolDownfunc;
...
public class CoolDownProc {
    ...
    //Restart and set level
    private void vProc_CoolDown_Mode02() {
        if(mCoolDownfunc.vCoolDownfunc_setLevel())
        {
            lStartTimeMillis = System.currentTimeMillis();
            vSetState(CoolDownState.PROC_GETSTATUS);
        }
