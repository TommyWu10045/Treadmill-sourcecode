...
import com.rtx.treadmill.RtxMainFunctionBike.TargetTrain.TargetTrainExerciseLayout.TargetTrainSimple_BodyFat_Layout_E;
import com.rtx.treadmill.RtxMainFunctionBike.TargetTrain.TargetTrainExerciseLayout.TargetTrainSimple_Calories_Layout_E;
import com.rtx.treadmill.RtxMainFunctionBike.TargetTrain.TargetTrainExerciseLayout.TargetTrainSimple_Distance_Layout_E;
import com.rtx.treadmill.RtxMainFunctionBike.TargetTrain.TargetTrainExerciseLayout.TargetTrainSimple_Frequency_Layout_E;
import com.rtx.treadmill.RtxMainFunctionBike.TargetTrain.TargetTrainExerciseLayout.TargetTrainSimple_Weight_Layout_E;
...
//        if(check_Login())
//        {
//            mMainActivity.mMainProcBike.targetTrainProc.vSetNextState(TargetTrainState.PROC_CLOUD_LOAD_GOAL);
//        }
    }
    ...
    {
        {
            addRtxImagePaddingViewToLayout(imageView_InfoButton, R.drawable.info_icon, 811, 40, 34, 34, 30);
        }
    }
        ...
        else
        {
            ...
            mMainActivity.dialogLayout_Login.fillerTextView_Login.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    //mMainActivity.mMainProcBike.vSetBeforeLoginState(MainState.PROC_TARGET_TRAIN);
                    mMainActivity.mMainProcBike.targetTrainProc.vMainChangePage(MainState.PROC_LOGIN);
    ...
    {
        mMainActivity.mMainProcBike.targetTrainProc.vMainChangePage(MainState.PROC_HOME);
    }
...
//    }
    ...
    {
        mMainActivity.mMainProcBike.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_DETAIL_DISTANCE);
    }

    protected void vShowDetailCalories()
    {
        mMainActivity.mMainProcBike.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_DETAIL_CALORIES);
    }
    ...
    {
        mMainActivity.mMainProcBike.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_DETAIL_BODYFAT);
    }

    protected void vShowDetailFrequency()
    {
        mMainActivity.mMainProcBike.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_DETAIL_FREQUENCY);
    }
    ...
    {
        mMainActivity.mMainProcBike.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_HISTORY_MAIN);
    }
