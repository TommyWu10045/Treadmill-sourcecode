...
public class TargetTrainDetail_BodyFat_Layout extends TargetTrainDetailBaseLayout {
    ...
    protected void add_View()
    {
        ...
        add_Botton_Item_3(800,137);//By Alan
        add_Botton_Item_4(1100,128);//By Alan
    ...
    {
        mMainActivity.mMainProcTreadmill.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_MODIFY_CURRENT_BODYFAT);
    }
