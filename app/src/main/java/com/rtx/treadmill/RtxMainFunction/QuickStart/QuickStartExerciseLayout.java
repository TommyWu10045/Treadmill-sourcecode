...
public class QuickStartExerciseLayout extends ExerciseLayout {
    private String TAG = "Jerry" ;

    private MainActivity        mMainActivity;
    private Context mContext;

    public QuickStartExerciseLayout(Context context, MainActivity mMainActivity) {
    ...
    protected void vClickHomeCallBack()
    {
        ...
        mMainActivity.mMainProcTreadmill.quickStartProc.vMainChangePage(MainState.PROC_HOME);
    }
