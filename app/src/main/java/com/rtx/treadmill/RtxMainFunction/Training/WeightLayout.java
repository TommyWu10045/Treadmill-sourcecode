...
public class WeightLayout extends Rtx_NumberWheel_Weight_BaseLayout {
    ...
    {
        mMainActivity.mMainProcTreadmill.trainingProc.vSetNextState(TrainingState.PROC_SHOW_TRAINING);
    }

    @Override
    public void vClickButton_Confirm()
    {
        mMainActivity.mMainProcTreadmill.trainingProc.vSet_weight(getCurrentVal_Metric());
