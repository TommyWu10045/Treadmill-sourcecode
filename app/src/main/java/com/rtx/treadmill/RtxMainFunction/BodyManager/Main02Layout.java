...
public class Main02Layout extends Rtx_BaseLayout {
    ...
    public Main02Layout(Context context, MainActivity mMainActivity) {
        super(context);


        MyLog.d("===>  Main02Layout");
...
//        body fat
        ...
        iw = 85;
        ih = 85;
        addRtxImageViewToLayout(i_next, R.drawable.triangle_prev, ix, iy, iw, ih);
...
//        sdata = "N/A";
    ...
    class ButtonListener implements OnClickListener
    {
        ...
        public void onClick(View v)
        {
            if(v == i_edit_pen)
            {
                MyLog.d("===>  Main02Layout i_edit_pen click");
                vEditPen_icon(); }
