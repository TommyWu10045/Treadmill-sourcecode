...
public class DateLayout extends Rtx_NumberWheel_date_BaseLayout {
    ...
    {
        if(mMainActivity.mMainProcTreadmill.performanceProc.i_Get_type() == 3)
        {
    ...
    protected void vClickButton_Confirm()
    {
        ...
        mMainActivity.mMainProcTreadmill.performanceProc.vSet_date(cBirthDay);
        mMainActivity.mMainProcTreadmill.performanceProc.vSetNextState(PerformanceState.PROC_ADD_TIME);
    }
