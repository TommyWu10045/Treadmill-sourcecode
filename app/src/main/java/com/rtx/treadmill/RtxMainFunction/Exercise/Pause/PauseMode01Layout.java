...
public class PauseMode01Layout extends PauseLayout {
    ...
    public PauseMode01Layout(Context context, MainActivity mMainActivity) {
    ...
    public void vClickButton01()
    {
        ...
        mMainActivity.mMainProcTreadmill.exerciseProc.pauseProc.vSetNextState(PauseState.PROC_PAUSE_STOP);
    }

    @Override
    public void vClickButton02()
    {
        mMainActivity.mMainProcTreadmill.exerciseProc.pauseProc.vSetNextState(PauseState.PROC_PAUSE_MODE1_RESUME);
    }
