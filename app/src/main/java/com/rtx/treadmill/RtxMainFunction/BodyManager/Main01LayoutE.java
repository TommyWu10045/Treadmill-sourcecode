...
public class Main01LayoutE extends Rtx_BaseLayoutE {
    ...
    public Main01LayoutE(Context context, MainActivity mMainActivity) {
        super(context);
        MyLog.d("===>  Main01LayoutE");
        mContext = context;
...
//        first line
        ...
        for(iLoop = 0; iLoop < imax; iLoop++) {
            ...
            ix_temp = ix + 85 + ix_shift;//By Alan
            iy_temp += ih_temp;
            iw_temp = 36;
...
//        body fat
        ...
        iw = iGet_Scale(85);
        ih = iGet_Scale(85);
        addRtxImage(f_back, i_next, R.drawable.triangle_next, ix, iy, iw, ih, 0, null);
...
//        body info
        ...
        iw = iGet_Scale(108);
        ih = iGet_Scale(108);
        addRtxImage(f_back, i_bdinfo, R.drawable.bd_info, ix, iy, iw, ih, 0, null);
    ...
    class ButtonListener implements OnClickListener
    {
        ...
        {
            if(v == i_edit_pen)                 {
                MyLog.d("===>  Main01LayoutE i_edit_pen click");
                vEditPen_icon(); }
