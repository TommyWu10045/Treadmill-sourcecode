...
public class TargetTrainDetail_Frequency_Layout extends TargetTrainDetailBaseLayout {
    ...
    protected void add_View()
    {
        ...
        addRtxTextViewToLayout(textView_WeekText, 62.71f, Common.Color.blue_1, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, -1, 478 - 50, 1280, 34 + 100);
    ...
    {
        //String sWeek;
        String sWeek= LanguageData.s_get_string(mContext,R.string.week);
