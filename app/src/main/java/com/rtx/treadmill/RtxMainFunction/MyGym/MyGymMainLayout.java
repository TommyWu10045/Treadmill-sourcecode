            ...
            mLayout_BulletinList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if(iIndex < list_CloudBulletinInfo.size())
                    {
                        ...
                        mMainActivity.mMainProcTreadmill.myGymProc.vSetBulletinID(iIndex);
                        mMainActivity.mMainProcTreadmill.myGymProc.vSetNextState(MyGymState.PROC_SHOW_PAGE_BULLETIN_DETAIL);
                    }
                }
            });
        }
...
//        }
    ...
    {
        mMainActivity.mMainProcTreadmill.myGymProc.vMainChangePage(MainState.PROC_HOME);
    }
    ...
    {
        mMainActivity.mMainProcTreadmill.myGymProc.vClearSearchList();
