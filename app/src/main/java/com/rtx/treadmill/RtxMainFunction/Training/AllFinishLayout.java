...
public class AllFinishLayout extends SummaryLayout{
    ...
    protected void add_CustomerUpdateView(){
        ...
        switch(imode){
            case 0x00:
                ...
                break;
            case 0x01:
                stitle=LanguageData.s_get_string(mContext, R.string.hill);
                break;
            case 0x02:
                stitle=LanguageData.s_get_string(mContext, R.string.fatburn);
                break;
            case 0x03:
                stitle=LanguageData.s_get_string(mContext, R.string.cardio);
                break;
            case 0x04:
    ...
    protected void v_logout(){
        mMainActivity.mMainProcTreadmill.trainingProc.vSetNextState(TrainingState.PROC_SHOW_LOGOUT);
    }

    @Override
    protected void v_done(){
        mMainActivity.mMainProcTreadmill.trainingProc.vSetNextState(TrainingState.PROC_SHOW_DONE);
    }
}
