...
public class DistanceLayout extends Rtx_Distance_BaseLayout {
    ...
    {
        mMainActivity.mMainProcTreadmill.performanceProc.vSetNextState(PerformanceState.PROC_ADD_DURATION);
    }

    @Override
    public void vClickButton_Confirm()
    {
        mMainActivity.mMainProcTreadmill.performanceProc.vSet_distance(getCurrentVal_Metric());
        mMainActivity.mMainProcTreadmill.performanceProc.vSetNextState(PerformanceState.PROC_ADD_CALORIES);
    }
