    ...
    private void addDataBlock(int iTime , float fSpeed , float fIncline)
    {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mMainActivity.mMainProcTreadmill.myWorkoutProc.vSetSettingIndex(iSearchIndexFromList(iViewId));
                mMainActivity.mMainProcTreadmill.myWorkoutProc.vSetNextState(MyWorkoutState.PROC_SHOW_PAGE_SETTING);
            }
        });
...
//        }
    ...
    {
        mMainActivity.mMainProcTreadmill.myWorkoutProc.vSetSettingIndex(-1);
        mMainActivity.mMainProcTreadmill.myWorkoutProc.vSetNextState(MyWorkoutState.PROC_SHOW_PAGE_SETTING);
    }
