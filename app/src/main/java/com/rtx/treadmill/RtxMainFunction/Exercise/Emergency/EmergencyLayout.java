...
public abstract class EmergencyLayout extends Rtx_BaseLayout {
    ...
    private void add_View()
    {
        ...
        if(EngSetting.i_Get_ExerciseType() != EngSetting.RUNNING6)
        {
            ...
            ih = 40;
            fsize = 28.00f;
            sdata = LanguageData.s_get_string(mContext, R.string.emergency_note_FOR_M6);
            addRtxTextView(this, t_note, sdata, fsize, Common.Color.emergency_word_yellow, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER, ix, iy, iw, ih);
            ...
            iw = 231;
            ih = 283;
            addRtxImagePaddingViewToLayout(i_button, R.drawable.emergency_button2, ix, iy, iw, ih, 0);
