...
public class TargetTrainChooseTargetLayout extends Rtx_BaseLayout {
    ...
    {
        mMainActivity.mMainProcTreadmill.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_ADD_SELECT_TYPE);
        cloud_TargetGoal.setType(-1);
    }

    private void vEnterCalAddPage()
    {
        mMainActivity.mMainProcTreadmill.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_ADD_CAL_SET_CAL);
    }

    private void vEnterWeiAddPage()
    {
        mMainActivity.mMainProcTreadmill.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_ADD_WEI_SET_CURRENT);
    }

    private void vEnterBodyFatAddPage()
    {
        mMainActivity.mMainProcTreadmill.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_ADD_BDY_FAT_SET_CURRENT);
    }

    private void vEnterFreqAddPage()
    {
        mMainActivity.mMainProcTreadmill.targetTrainProc.vSetNextState(TargetTrainState.PROC_SHOW_PAGE_ADD_FREQ_SELECT_DAY);
    }
