...
import com.rtx.treadmill.RtxBaseLayout.Rtx_HRExerciseBaseLayout;
...
public class HRExerciseLayout extends Rtx_HRExerciseBaseLayout {
    ...
    public HRExerciseLayout(Context context, MainActivity mMainActivity) {
