...
public class LoginLayout extends Rtx_BaseLayout {
    ...
    private void add_View()
    {
...

        {
            ...
            addRtxTextViewToLayout(textView_Explain_1, R.string.login_expand_1, 24.73f, Common.Color.login_word_dark_black, Common.Font.Relay_Medium, Typeface.NORMAL, Gravity.CENTER_VERTICAL | Gravity.LEFT, 195, 536, 641, 34);//By Alan
            addRtxTextViewToLayout(textView_Explain_2, R.string.login_expand_2, 24.73f, Common.Color.login_word_dark_black, Common.Font.Relay_Medium, Typeface.NORMAL, Gravity.CENTER_VERTICAL | Gravity.LEFT, 195, 536+45, 641, 34);//By Alan
            addRtxTextViewToLayout(textView_Explain_3, R.string.login_expand_3, 24.73f, Common.Color.login_word_dark_black, Common.Font.Relay_Medium, Typeface.NORMAL, Gravity.TOP | Gravity.LEFT, 195, 631-3, 641, 68);//By Alan
            ...
            addRtxTextViewToLayout(textView_NoteContents, R.string.note_contents, 19.00f, Common.Color.login_word_blue, Common.Font.Relay_Medium, Typeface.NORMAL, Gravity.CENTER_VERTICAL | Gravity.LEFT, 198, 713, 984, 46);//By Alan
        }
    }
    ...
    {
        mMainActivity.mMainProcTreadmill.loginProc.vSetNextState(LoginState.PROC_SHOW_PAGE_LOGIN_EMAIL);
    }
    ...
    {
        mMainActivity.mMainProcTreadmill.loginProc.vSetNextState(LoginState.PROC_SHOW_PAGE_FORGOT_PASSWORD);
    }
