package com.rtx.treadmill.RtxMainFunction.Exercise.Error;
...
public class ErrorLayout extends Rtx_BaseLayout {
    ...
    public ErrorLayout(Context context, MainActivity mMainActivity) {
        super(context);
