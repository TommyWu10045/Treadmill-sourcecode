...
public class TargetTrainCalendar_Week_Layout extends Rtx_BaseLayout {
    ...
    private void init_View()
    {
        ...
        {
            if(calendarView == null)                { calendarView = new RtxCalendarView(mContext,600,650,mMainActivity.mMainProcTreadmill.targetTrainProc.cGetValidStartDate()); }
        }
    }
    ...
    public void setDate(Calendar cal)
    {
        ...
        else
        {
            ...
            cal_Start = mMainActivity.mMainProcTreadmill.targetTrainProc.cGetValidStartDate();
...
//            Log.e("Jerry","iDiffDays = " + iDiffDays);
    ...
    private void vClickButton_Back()
    {
        ...
        TargetTrainState mTargetTrainState = mMainActivity.mMainProcTreadmill.targetTrainProc.vGerPreState();

        if(mTargetTrainState != TargetTrainState.PROC_NULL)
        {
            mMainActivity.mMainProcTreadmill.targetTrainProc.vSetNextState(mTargetTrainState);
        }
        else
        {
    ...
    {
//        vClearCalendarView();
//        calendarView = new RtxCalendarView(mContext,600,650,mMainActivity.mMainProcTreadmill.targetTrainProc.cGetValidStartDate());
//        init_RtxCalendarView();
