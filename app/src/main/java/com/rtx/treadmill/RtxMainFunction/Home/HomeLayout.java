...
import static com.rtx.treadmill.GlobalData.LanguageData.s_get_string;
...
public class HomeLayout extends Rtx_BaseLayout {
    ...
    private void add_View()
    {
        //Image
        {
            ...
            //1st icon
            addRtxImageViewToLayout(imageView_Icon_Training, R.drawable.main_icon_training, 84, 163, 153, 153);
            addRtxImageViewToLayout(imageView_Icon_HeartRateControl, R.drawable.main_icon_heart_rate_control, 324, 163, 153, 153);
            ...
            addRtxImageViewToLayout(imageView_Icon_TargetTrain, R.drawable.main_icon_target_train_star, 1048, 163, 153, 153);

            //2st icon
            addRtxImageViewToLayout(imageView_Icon_MyPerformance, R.drawable.main_icon_my_performance_star, 84, 398, 153, 153);
            addRtxImageViewToLayout(imageView_Icon_BodyManager, R.drawable.main_icon_body_manager_star, 324, 398, 153, 153);
            addRtxImageViewToLayout(imageView_Icon_MyGym, R.drawable.main_icon_my_gym_star, 565, 398, 153, 153);
            addRtxImageViewToLayout(imageView_Icon_MyWorkout, R.drawable.main_icon_my_workout_star, 807, 398, 153, 153);
        ...
        //Text
        {
            ...
            //1st icon
            addRtxTextViewToLayout(textView_Icon_Training, R.string.training, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 34, 328, 252, 50);//By Alan
            addRtxTextViewToLayout(textView_Icon_HeartRateControl, R.string.heart_rate_control, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 274, 328, 252, 50);//By Alan
            addRtxTextViewToLayout(textView_Icon_Hiit, R.string.hiit, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 515, 328, 252, 50);//By Alan
            addRtxTextViewToLayout(textView_Icon_PhysicalTest, R.string.physical_test, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 757, 328, 252, 50);//By Alan
            addRtxTextViewToLayout(textView_Icon_TargetTrain, R.string.target_train, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 998, 328, 252, 50);//By Alan

            //2st icon
            addRtxTextViewToLayout(textView_Icon_MyPerformance, R.string.my_performance, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 34, 563, 252, 50);//By Alan
            addRtxTextViewToLayout(textView_Icon_BodyManager, R.string.body_manager, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 274, 563, 252, 50);//By Alan
            addRtxTextViewToLayout(textView_Icon_MyGym, R.string.my_gym, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 515, 563, 252, 50);//By Alan
            addRtxTextViewToLayout(textView_Icon_MyWorkout, R.string.my_workout, 20f, Common.Color.main_word_white, Common.Font.Relay_Bold, Typeface.NORMAL, Gravity.CENTER_HORIZONTAL, 757, 563, 252, 50);//By Alan
            ...
            addRtxTextViewToLayout(textView_Temp, EngSetting.s_Get_DEFAULT_TEMP(), 28.87f, Common.Color.main_word_white, Common.Font.Relay_Medium, Typeface.NORMAL, Gravity.LEFT, 88, 680, 242, 37);//By Alan
...
//            addViewToLayout(mRtxDigitalDate,68,693,291,37);
            addRtxTextViewToLayout(textView_Time, 28.87f,Common.Color.main_word_white,Common.Font.Relay_Medium,Typeface.NORMAL, Gravity.RIGHT,965,678,224,70);//By Alan
    ...
    protected void vUpdateMailState(UiDataStruct.HOME_USER_INFO userInfo)
    {
        ...
        if(userInfo.bGetNewInfo())
        {
            ...
            {
                textView_Mail.setText(s_get_string(mContext,R.string.hi) + " " + CloudDataStruct.CloudData_17.Get_output(Cloud_17_GET_USR_BSC.Output.USR_NAM));
                setEffectMailFullAlpha();
                addRtxImagePaddingViewToLayout(imageView_Mail, R.drawable.main_mail_icon, 777, 47, 35, 26,30);
            }
            else
            {
                textView_Mail.setText(s_get_string(mContext,R.string.you_have_a_message));
                addRtxImagePaddingViewToLayout(imageView_Mail, R.drawable.main_mail_icon, 777, 47, 35, 26,30);
        ...
        mMainActivity.dialogLayout_HomeInfo.fillerTextView_OK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if(!mMainActivity.dialogLayout_HomeInfo.bNextPage())
                {
                    ...
                    mMainActivity.mMainProcTreadmill.homeProc.vSetNextState(HomeState.PROC_UPDATE_USER_INFO);
                }
            }
        });
    }
