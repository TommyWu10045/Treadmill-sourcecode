...
//        menu
        sdata = LanguageData.s_get_string(mContext, R.string.select_goal);
...
//      weight icon
    ...
    private void vClickitem(int iLoop)
    {
        if(iLoop == 2)
        {
            mMainActivity.mMainProcTreadmill.trainingProc.vSet_mode(0+mMainActivity.mMainProcTreadmill.trainingProc.i_target_start);
            mMainActivity.mMainProcTreadmill.trainingProc.vSetNextState(TrainingState.PROC_SHOW_CALORIES);
        }
        else if(iLoop == 0)
        {
            mMainActivity.mMainProcTreadmill.trainingProc.vSet_mode(1+mMainActivity.mMainProcTreadmill.trainingProc.i_target_start);
            mMainActivity.mMainProcTreadmill.trainingProc.vSetNextState(TrainingState.PROC_SHOW_TIME);
        }
        else if(iLoop == 1)
        {
            mMainActivity.mMainProcTreadmill.trainingProc.vSet_mode(2+mMainActivity.mMainProcTreadmill.trainingProc.i_target_start);
