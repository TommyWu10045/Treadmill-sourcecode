...
public class DatasyncWebLayout extends Rtx_BaseLayout {
    ...
    private String sUrl_SuccessKey = "ws.cfamanage.com";
    private int iForwardingCount = 0;
    private final int iSuccessForwardingCount = 2;

    public DatasyncWebLayout(Context context, MainActivity mMainActivity) {
        super(context);
...
//        i_web_but.setBackgroundColor(Common.Color.gray);
    ...
    private void Open_Webview()
    {
        ...
        if(shttp_login != null)
        {
            ...
            if(imode == 2) {
                w_view.getSettings().setUserAgentString("here");
            }
        }
    ...
    WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            bCheck_SuccessRule(sUrl_SuccessKey,url);
...
//            }
    ...
    private boolean bCheck_success_keyword(String skey, String sresource)
    {
        ...
        {
            bret = true;
            mMainActivity.mMainProcTreadmill.settingProc.v_set62_status();
        }

        return bret;
    }

    private boolean bCheck_SuccessRule(String sKey, String sUrl)
    {
        boolean bret = false;

        if(iForwardingCount >= iSuccessForwardingCount)
        {
            if(sUrl.contains(sKey))
            {
                iForwardingCount = 0;
                bret = true;
                mMainActivity.mMainProcTreadmill.settingProc.v_set62_status();
    ...
    ////////////////////////////////////////////////////////////////////////////////////
    private void vClickClose(boolean bUpload)
    {
    ...
    class ButtonListener implements OnClickListener
    {
        ...
        {
            if(v == i_web_but)  { vClickClose(false); }
        }
    }
}
