...
public class TrainingLayout extends Rtx_BaseLayout {
    ...
    {
        int iLoop ;
        istr_list = mMainActivity.mMainProcTreadmill.trainingProc.itype_tread_list;
        sinfo_list = mMainActivity.mMainProcTreadmill.trainingProc.sinfotreadlist;
...
//        icon
    ...
    {
        mMainActivity.mMainProcTreadmill.trainingProc.vMainChangePage(MainState.PROC_HOME);
    }

    private void vClickinfo(int iLoop)
    {
        mMainActivity.mMainProcTreadmill.trainingProc.vSet_mode(iLoop);
    ...
    {
        mMainActivity.mMainProcTreadmill.trainingProc.vSet_mode(mMainActivity.mMainProcTreadmill.trainingProc.i_target_start);
        mMainActivity.mMainProcTreadmill.trainingProc.vSetNextState(TrainingState.PROC_SHOW_WEIGHT);
    }
