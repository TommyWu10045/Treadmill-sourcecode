    ...
    private void vClickitem(int iLoop)
    {
        switch (iLoop)
        {
            case 0:
                ...
                break;
            case 1:
                mMainActivity.mMainProcTreadmill.performanceProc.vSetNextState(PerformanceState.PROC_SHOW_MONTH);
                break;
            case 2:
                mMainActivity.mMainProcTreadmill.performanceProc.vSetNextState(PerformanceState.PROC_SHOW_YEAR);
                break;
            default:
                break;
        }
