...
public class WeightLayout extends Rtx_NumberWheel_Weight_BaseLayout {
    ...
    {
        mMainActivity.mMainProcTreadmill.physicalProc.vSetNextState(PhysicalState.PROC_SHOW_PHYSICAL);
    }

    @Override
    public void vClickButton_Confirm()
    {
        mMainActivity.mMainProcTreadmill.physicalProc.vSet_weight(getCurrentVal_Metric());
