...
public class RegBirthdayLayout extends Rtx_NumberWheel_Birthday_BaseLayout {
    ...
    {
        mMainActivity.mMainProcTreadmill.loginProc.vSetNextState(LoginState.PROC_SHOW_PAGE_REG_HEIGHT);
    }
    ...
    public void vClickButton_Confirm()
    {
        ...
        mMainActivity.mMainProcTreadmill.loginProc.vSetNextState(LoginState.PROC_SHOW_PAGE_REG_POLICY);
    }
}
