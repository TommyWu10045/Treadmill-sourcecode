...
public class WeightLayout extends Rtx_NumberWheel_Weight_BaseLayout {
    ...
    {
        mMainActivity.mMainProcTreadmill.heartrateProc.vSetNextState(HeartRateState.PROC_SHOW_MAIN);
    }

    @Override
    public void vClickButton_Confirm()
    {
        mMainActivity.mMainProcTreadmill.heartrateProc.fweight = getCurrentVal_Metric();
