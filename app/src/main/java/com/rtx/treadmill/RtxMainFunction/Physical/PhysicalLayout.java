...
public class PhysicalLayout extends Rtx_BaseLayout {
    ...
    public void init_View()
    {
        ...
        sinfo_list = mMainActivity.mMainProcTreadmill.physicalProc.sinfotreadlist;
...
//        icon
        ...
        for(iLoop = 0; iLoop < imax; iLoop++) {
            ...
            addRtxTextViewToLayout(t_phy[iLoop], sdata.toUpperCase(), fsize, Common.Color.physical_word_white, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, ix - 29, iy, iw + 58, ih);
            ix += ix_shift;
        }
    ...
    {
        mMainActivity.mMainProcTreadmill.physicalProc.vMainChangePage(MainState.PROC_HOME);
    }

    private void vClickinfo(int iLoop)
    {
        mMainActivity.mMainProcTreadmill.physicalProc.vSet_mode(iLoop);
        ...
        Dialog_UI_Info.v_tist_Dialog(istr_list[iLoop][0], -1, stitle01, null, sinfo01, null, sinfo_list[iLoop], ImageView.ScaleType.CENTER_INSIDE);
    ...
    {
        String stitle01 = LanguageData.s_get_string(mContext, R.string.physical_test).toUpperCase();
        String sinfo01 = LanguageData.s_get_string(mContext, R.string.phy_dialog_info).toUpperCase();
