...
public class View_MyWorkout_DataBlock extends Rtx_BaseLayout {
    ...
    private void add_View()
    {
        ...
        addRtxTextViewToLayout(textView_Time, -1, 43.33f, Common.Color.purple_2, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, 26, 182, 131, 46);
        ...
        addRtxTextViewToLayout(textView_Incline, -1, 43.33f, Common.Color.purple_2, Common.Font.Relay_Black, Typeface.NORMAL, Gravity.CENTER, 26, 462, 131, 46);

        addRtxImagePaddingViewToLayout(imageView_Time, R.drawable.workout_block_time, 76, 133, 30, 30, 0);
        addRtxImagePaddingViewToLayout(imageView_Speed, R.drawable.workout_block_speed, 76, 277, 29, 15, 0);
        addRtxImagePaddingViewToLayout(imageView_Incline, R.drawable.workout_block_incline, 76, 413, 30, 23, 0);
