...
public class MyWorkout_Setting_Layout extends Rtx_BaseLayout {
    ...
    private void init_View()
    {
...

        {
            ...
            if(mUpDownButton_Incline == null)   { mUpDownButton_Incline = new RtxUpDownButton(mContext,15f,0f,0.5f,0f,""); }
...
//            else
    ...
    private void add_View()
    {
        ...
        addRtxTextViewToLayout(textView_Min    , R.string.min, 33.05f, Common.Color.gray_2, Common.Font.Relay_BoldItalic, Typeface.NORMAL, Gravity.CENTER, 612-50, 246 - 25, 56 + 100, 35 + 50);
    ...
    protected void vSetWorkoutItemInfo(UiDataStruct.WORKOUT_ITEM_INFO workoutItem, int iIndex)
    {
        ...
        else
        {
            ...
            vSetVal(workoutItem.list_Stage.get(iIndex).iTime,workoutItem.list_Stage.get(iIndex).fGetSpeed(),workoutItem.list_Stage.get(iIndex).fGetIncline());
        }
    }
...
//        Log.e("Jerry","iTimeVal = " + iTimeVal);
    ...
    protected void vShowDeleteDialog()
    {
        ...
        mMainActivity.dialogLayout_Delete.fillerTextView_Delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                vDeleteDialog();
                mMainActivity.mMainProcTreadmill.myWorkoutProc.vSetDeleteMode(1);
