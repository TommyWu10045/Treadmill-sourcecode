...
public class BodyManagerProc {
    ...
    public boolean mhaveChangeData = false;
    ...
    public void vSetHaveChangeData(boolean haveChangeData)
    {
        mhaveChangeData = haveChangeData;
    }
    ...
    {
        mMainActivity.mMainProcTreadmill.bodymanagerProc.vSetNextState(BodyManagerState.PROC_EXIT);
