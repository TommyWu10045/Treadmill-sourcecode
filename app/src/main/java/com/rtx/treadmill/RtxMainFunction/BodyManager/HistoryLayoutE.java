...
public class HistoryLayoutE extends Rtx_BaseLayoutE {
    ...
    public HistoryLayoutE(Context context, MainActivity mMainActivity) {
        super(context);
        ...
        public void onScrollStateChanged(AbsListView view, int scrollState) {
            if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
                if (totalItemCount == (firstVisibleItem + visibleItemCount)) {
                    mMainActivity.mMainProcTreadmill.bodymanagerProc.vSetNextState(BodyManagerState.PROC_CLOUD_HIS_REFRESH);
                }
            }
        }
    };
