...
public class XAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLine(Canvas c) {
        ...
        if (mXAxis.getPosition() == XAxisPosition.BOTTOM
                ...
                || mXAxis.getPosition() == XAxisPosition.BOTH_SIDED) {
            c.drawLine(mViewPortHandler.contentLeft()- mXAxis.get_xline_offset(),
    ...
    protected void drawLabels(Canvas c, float pos, MPPointF anchor) {
        ...
        //Log.e("Tom" , "X Axis positions.length=" + positions.length);
        ...
        String xslabel = mXAxis.get_xlabel_string();
        if (xslabel.compareTo("") != 0) {
            mAxisLabelPaint.setTextSize(mXAxis.get_xlabel_size());
            int xlabel_xshift = mXAxis.get_xlabel_xShift();
            int xlabel_yshift = mXAxis.get_xlabel_yShift();
            drawLabel(c, xslabel, mViewPortHandler.contentLeft()- mXAxis.get_xline_offset() - xlabel_xshift, pos - xlabel_yshift, anchor, labelRotationAngleDegrees);
        }
