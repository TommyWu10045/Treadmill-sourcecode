...
public class YAxisRenderer extends AxisRenderer {
    ...
    private int i_text_paint_width(String str)
    {
        int text_width = 0;

        Rect bounds = new Rect();
        mAxisLabelPaint.getTextBounds(str, 0, str.length(), bounds);
    ...
    private int i_text_paint_height(String str)
    {
        int text_height = 0;
    ...
    protected void drawYLabels(Canvas c, float fixedPosition, float[] positions, float offset) {
        ...
        int iw = 0;
        int iw_len = 0;
        String sdata = mYAxis.get_rtx_unit();

        // draw
        //Log.e("Tom", "drawYLabels fixedPosition=" + fixedPosition);
        //Log.e("Tom", "drawYLabels offset=" + offset);

        for (int i = from; i < to; i++) {
            if(i == to - 1)
            {
                iw_len = i_text_paint_width(text);
                iw = i_text_paint_width(sdata);
                c.drawText(sdata, fixedPosition - iw_len + iw,  positions[i * 2 + 1] + offset , mAxisLabelPaint);
            }else {
