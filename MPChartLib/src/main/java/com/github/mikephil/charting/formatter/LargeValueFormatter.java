...
public class LargeValueFormatter implements IValueFormatter, IAxisValueFormatter
{
    ...
    public LargeValueFormatter(String appendix, int iDecimalNumber) {
        this();
        mText = appendix;
        this.iDecimalNumber = iDecimalNumber;
    }
    ...
    private String makePretty(double number) {
        ...
        {
            r = String.format("%." + iDecimalNumber +  "f",number);
        }
