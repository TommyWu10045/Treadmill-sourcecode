...
public class YAxis extends AxisBase {
    ...
    public void setDrawBottomYLabelEntryEnabled(boolean enabled) {
    ...
    public float getRequiredWidthSpace(Paint p) {
        ...
        //Log.e("Tom" , "drawLabels====label=" + label + "====minWidth=" + minWidth + "====width=" + width);
    ...
    public void set_rtx_unit(String sunit)
    {
        this.sUnit = sunit;
    }

    public String get_rtx_unit()
    {
        return this.sUnit;
    }
